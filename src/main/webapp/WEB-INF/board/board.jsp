...
<body>
	<div class="boarddiv">
		<div class="divall">
			<form class="form-inline boardser" action="/board" method="get">
				<select name="searchType" class="form-control mr-sm-2">
					...
					autocomplete="off" placeholder="검색어를 입력하세요."> <input
					value="${pagination.b_type}" name="b_type" style="display: none">
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<c:forEach items="${boardList}" var="board" varStatus="status">
							<tr onclick="sel_board(${board.b_number})"
						...
						<ul class="pagination justify-content-center">
							...
							<c:forEach begin="${pagination.startPage}"
								...
								<li class="page-item"><a
									class="page-link ${pagination.currPageNo == idx ? 'active' : ''}"
									id="page-btn${idx}" href="#"
			...
			<div class="boardin">
							<a class="b_insert_btn"
								href="/boardpage?b_type=${pagination.b_type }">글쓰기</a>
			</div>
						</c:if>
				</c:when>
				</c:choose>
