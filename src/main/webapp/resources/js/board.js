...
currPageNo = (range - 1) * pageSize; 
  ...
  //관리자 이전 버튼
function fn_prev_admin(currPageNo, range, pageSize) {
    var searchType = document.getElementById('paginationData').getAttribute('data-searchType');
    var keyword = document.getElementById('paginationData').getAttribute('data-keyword');
    var b_type = document.getElementsByName('b_type')[0].value;
...
currPageNo = (range - 1) * pageSize; 
    ...
    var url = "/boardadmin";    //여기에 페이지 이동하는 매핑 url 
    url = url + "?currPageNo=" + currPageNo;
    url += "&b_type=" + b_type;
    url = url + "&range=" + range;
    url = url + "&searchType=" + searchType;
 ...
 //관리자 댓글 이전 버튼
function fn_prev_commentAdmin(currPageNo, range, pageSize) {
    var searchType = document.getElementById('paginationData').getAttribute('data-searchType');
    var keyword = document.getElementById('paginationData').getAttribute('data-keyword');
   // var b_type = document.getElementsByName('b_type')[0].value;
...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
   ...
   var b_type = document.getElementsByClassName('b_type')[0].value;
    ...
    function fn_pagination_admin(currPageNo, range) {
   ...
   var b_type = document.getElementsByName('b_type')[0].value;
    ...
    //관리자 댓글 번호 클릭
        function fn_pagination_commentAdmin(currPageNo, range, b_number) {
   var b_type = document.getElementsByClassName('b_type')[0].value;
   
    var searchType = document.getElementById('paginationData').getAttribute('data-searchType');
    var keyword = document.getElementById('paginationData').getAttribute('data-keyword');
    
    var url = "/admin/boarddetail";   //여기에 페이지 이동하는 매핑 url 
...
function fn_next_comment(currPageNo, range, pageSize) {
   ...
   url += "&b_number=" + b_number;
    ...
    //관리자 다음 버튼 이벤트
function fn_next_admin(currPageNo, range, pageSize) {
    var searchType = document.getElementById('paginationData').getAttribute('data-searchType');
    var keyword = document.getElementById('paginationData').getAttribute('data-keyword');
    var b_type = document.getElementsByName('b_type')[0].value;
...
//관리자 댓글 다음 버튼 클릭
function fn_next_commentAdmin(currPageNo, range, pageSize) {
    var searchType = document.getElementById('paginationData').getAttribute('data-searchType');
    var keyword = document.getElementById('paginationData').getAttribute('data-keyword');
    //var b_type = document.getElementsByName('b_type')[0].value;
...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
    ...
    function sel_board_admin(val){
         location.href = "/admin/boarddetail?b_number="+val;
      }
