...
<body>
  ...
  <path
				...
				<div class="mainli">
					<!-- 우측 교수소개, 메뉴얼 div  -->
					<div class="imgBox" onclick="location.href='/professors'"
						style="cursor: hand">
  ...
  <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1z" />
						...
						<br> <br> <span class="subtext"> 교수 소개 </span> <br>
						<br>
					</div>
					<div class="imgBox" onclick="location.href='/menual'"
						style="cursor: hand">
						<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
  ...
  <path
						...
						<br> <br> <span class="subtext"> 메뉴얼 </span> <br> <br>
					</div>
				</div>
				<!-- 우측 교수소개, 메뉴얼 div  -->
			</div>
