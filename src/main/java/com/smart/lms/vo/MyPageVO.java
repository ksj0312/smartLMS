...
public class MyPageVO {
	...
	public String toString() {
		return "MyPageVO [c_number=" + c_number + ", c_name=" + c_name + ", c_create_date=" + c_create_date
				...
				+ ", c_term=" + c_term + ", c_day=" + c_day + ", c_status=" + c_status + ", id=" + id + ", name=" + name
				+ ", attendance=" + attendance + ", tardy=" + tardy + ", early=" + early + ", absent=" + absent + "]";
	}
}
